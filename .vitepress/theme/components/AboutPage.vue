...
const isZh =
    site.value.lang === "zh-CN" || page.value.relativePath.startsWith("zh/");
const emailAddress = "huoweifang@foxmail.com";
const xiaohongshuUrl =
    "https://www.xiaohongshu.com/user/profile/6767de890000000018017ac0";
...
const sendEmail = () => {
    const subject = encodeURIComponent(
        isZh ? "来自博客首页的邮件" : "Message from blog homepage",
    );
